...
export const Header = styled.h1`
  font-size: ${props => (props.altHeader ? "24px" : props.fontSize || "36px")};
  line-height: ${props => (props.altHeader ? "28px" : "42px")};
  font-weight: 700;
  color: ${props =>
    props.headerColor ? props.headerColor : props.theme.black};
...
export const SubHeader = styled.h2`
  ...
  font-weight: 500;
  color: ${props =>
    props.altSubHeader ? props.theme.white : props.theme.grayText};
...
export const BoldLabel = styled(SubLabel)`
  text-align: ${props =>
    props.textAlign ? props.textAlign : "left"} !important;
...
background-color: ${props =>
  props.altBackground ? props.theme.faintBlue : props.theme.transparent};
`;
