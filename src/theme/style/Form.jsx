...
export const MainInput = styled.input`
  ...
  margin-bottom: ${props => props.marginBottom || props.inputMargin};
  font-style: normal;
  font-weight: normal;
...
export const Select = styled.select`
  ...
  margin-bottom: ${props => props.marginBottom || props.selectMargin};
  border: 1px solid ${props => props.theme.inputBorder};
  background: transparent;
  padding: 8px;
  font-style: normal;
  ...
  background-image: ${props =>
    props.altArrow
      ? `url(${require("../../assets/images/down-arrow.svg")})`
      : `url(${require("../../assets/images/down-arrow.svg")})`};
...
export const TxtArea = styled.textarea`
  ...
  display: ${props => props.textareaDisplay};
  box-shadow: ${props => props.textareaBoxShadow};
  padding: 10px;
  font-style: normal;
  font-weight: normal;
  font-size: ${props => (props.fontSize ? props.fontSize : "14px")};
