...
import BookPage from "./container/Book";
import VisitorAboutPage from "./container/Visitor/about";
import VisitorFAQPage from "./container/Visitor/faqs";
import VisitorContactPage from "./container/Visitor/contact";
import VisitorReviewsPage from "./container/Visitor/reviews";
import VisitorAddReviewPage from "./container/Visitor/addreview";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route
          exact
          path="/become-a-partner/form-two"
        ...
        <Route
          exact
          path="/dashboard/businessdetaildashboard"
          component={BusinessDetailsDashboard}
        />
        <Route exact path="/dashboard/routes" component={VehicleRoutes} />
        <Route exact path="/dashboard/booking" component={BookPage} />
        ...
        />
        <Route exact path="/visitor/about" component={VisitorAboutPage} />
        <Route exact path="/visitor/faqs" component={VisitorFAQPage} />
        <Route exact path="/visitor/reviews" component={VisitorReviewsPage} />
        <Route
          exact
          path="/visitor/add-review"
          component={VisitorAddReviewPage}
        />
        <Route
          exact
          path="/visitor/contact-us"
          component={VisitorContactPage}
        />
